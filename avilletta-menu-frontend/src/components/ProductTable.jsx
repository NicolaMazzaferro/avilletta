                                ...
                                {products.map((product, index) => (
                                    <tr key={index} className="border-b dark:border-gray-700">
                                        ...
                                        <td className="px-4 py-3">
                                            <img className="rounded-full w-14 h-14" src={product.image ? `http://menu.avillettapizzeria.it/${product.image}` : defaultImage} alt="Product Image" style={{ maxWidth: '100px' }} />
                                        </td>
