                    ...
                    <div key={index} className="w-full md:w-1/3 mb-6">
                        <Link to={`/products/${category.name}`}>
                            <div className="m-3 font-semibold text-center rounded-3xl shadow-md flex flex-col justify-between h-52">
                                <img src={category.image ? `https://api.menu.avillettapizzeria.it/storage/${category.image}` : defaultImage} alt={category.name} className="w-full h-40 object-cover rounded-t-3xl" />
