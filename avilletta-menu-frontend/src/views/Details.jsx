            ...
            <header className="bg-dark-custom m-3 md:m-20 rounded-xl">
                <div className="container flex flex-col px-6 py-4 mx-auto space-y-6 md:h-128 md:py-16 md:flex-row md:items-center md:space-x-6">
                    ...
                    <div className="flex items-center justify-center w-full h-96 md:w-1/2">
                        <img className="object-cover w-full h-full max-w-2xl rounded-md text-light-custom" src={product.image ? `http://localhost:8000/${product.image}` : defaultImage} alt={product.name} />
                    </div>
                </div>
            </header>
